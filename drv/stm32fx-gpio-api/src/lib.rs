...
//! Client API for the STM32F3/4 GPIO server.
...
/// Enumeration of all GPIO ports on the STM32F3/4 series. Note that not all these
...
/// The STM32F3/4 GPIO hardware lets us configure up to 16 pins on the same port
